...
class UserController extends Controller
{
    ...
    public function signUp(Request $request){
        ...
        if($isRegistered === null){
            ...
            // $user = new Supermarket;
            // $user->id_supermarket = 1;
            // $user->nama_supermarket =  $request->input("inputNamaSupermarket");
            // $user->save();
            Supermarket::create([
                "id_supermarket" => User::all()->firstWhere("username", $request->input("inputUsername"))->id,
